...
namespace Ionic.Zlib
{
	...
	internal class ZlibBaseStream : System.IO.Stream
	{
			...
			: base()
		{
			...
			this._workingBuffer = new byte[ZlibConstants.WorkingBufferSizeDefault];
			this._stream = stream;
		...
		private void ReadZeroTerminatedString() {
			for( ; ; ) {
				// workitem 7740
		...
		public override System.Int32 Read(System.Byte[] buffer, System.Int32 offset, System.Int32 count)
		{
			...
			if (_z.AvailableBytesOut > 0)
			{
				...
				// are we completely done reading and in compression?
