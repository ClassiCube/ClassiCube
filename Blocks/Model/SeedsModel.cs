...
namespace ClassicalSharp.Blocks.Model {
	...
	public class SeedsModel : CubeModel {
		...
		public override void DrawFace( int face, byte meta, ref Neighbours state, ref int index, float x, float y, float z, VertexPos3fTex2fCol4b[] vertices, FastColour col ) {
