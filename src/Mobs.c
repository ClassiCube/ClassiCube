...
static void Mobs_Init(void) {
	...
	HacksComp_Init(&mob_hacks);
	/* Mobs don't get player-style hacks -- disable sprint/fly/noclip */
	mob_hacks.Enabled        = false;
	mob_hacks.CanSpeed       = false;
	mob_hacks.CanFly         = false;
	mob_hacks.CanNoclip      = false;
	mob_hacks.SpeedMultiplier = 1.0f;
