...
typedef cc_uint8 cc_key_flags; /*dont know if this is the best place to put this*/
#define KEY_NONE 0x00 /* key havent been handled */
#define KEY_HANDLED 0x01 /* key has been handled */
#define KEY_SUPPRESS_UI 0x02 /* key supresses GUI's key processing*/

typedef cc_key_flags (*BindTriggered)(int key, struct InputDevice* device); /*changes this to use 'cc_key_flag' instead of bool*/
