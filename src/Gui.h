...
enum GuiPriority {
	GUI_PRIORITY_DISCONNECT = 65,
	GUI_PRIORITY_OLDLOADING = 60,
	GUI_PRIORITY_MENU       = 55,
	GUI_PRIORITY_TOUCHMORE  = 50,
	GUI_PRIORITY_URLWARNING = 45,
	GUI_PRIORITY_TEXPACK    = 40,
	GUI_PRIORITY_TEXIDS     = 35,
	GUI_PRIORITY_TOUCH      = 30,
	GUI_PRIORITY_INVENTORY  = 25,
	GUI_PRIORTIY_TABLIST    = 20,
