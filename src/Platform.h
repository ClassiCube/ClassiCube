...
CC_API ReturnCode Socket_Available(SocketHandle socket, cc_uint32* available);
...
CC_API ReturnCode Socket_SetBlocking(SocketHandle socket, cc_bool blocking);
...
CC_API ReturnCode Socket_Read(SocketHandle socket, cc_uint8* data, cc_uint32 count, cc_uint32* modified);
/* Attempts to write data to the given socket. */
CC_API ReturnCode Socket_Write(SocketHandle socket, const cc_uint8* data, cc_uint32 count, cc_uint32* modified);
...
CC_API ReturnCode Socket_Poll(SocketHandle socket, int mode, cc_bool* success);
