...
#define GAME_APP_NAME  "ClassiCube 1.1.3 alpha"
#define GAME_APP_TITLE "ClassiCube 1.1.3 alpha"
#else
#define GAME_APP_NAME  "ClassiCube 1.1.3"
#define GAME_APP_TITLE "ClassiCube 1.1.3"
#endif
