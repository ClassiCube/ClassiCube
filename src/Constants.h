...
#define GAME_APP_NAME  "ClassiCube 1.1.9 alpha"
#define GAME_APP_TITLE "ClassiCube 1.1.9 alpha"
#else
#define GAME_APP_NAME  "ClassiCube 1.1.9"
#define GAME_APP_TITLE "ClassiCube 1.1.9"
#endif
...
enum FONT_STYLE { FONT_STYLE_NORMAL, FONT_STYLE_BOLD, FONT_FLAG_UNDERLINE = 0x80 };
