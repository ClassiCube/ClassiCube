...
#define GAME_APP_NAME  "ClassiCube 1.1.6 alpha"
#define GAME_APP_TITLE "ClassiCube 1.1.6 alpha"
#else
#define GAME_APP_NAME  "ClassiCube 1.1.6"
#define GAME_APP_TITLE "ClassiCube 1.1.6"
#endif
