...
#define GAME_APP_NAME  "ClassiCube 1.0.9 alpha"
#define GAME_APP_TITLE "ClassiCube 1.0.9 alpha"
#else
#define GAME_APP_NAME  "ClassiCube 1.0.9"
#define GAME_APP_TITLE "ClassiCube 1.0.9"
#endif
